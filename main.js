...
const gitClone = git => new Promise(cb => {
    let gitCloneResult = git.clone(process.env.SLACK_BOT_USERNAME,
        process.env.SLACK_BOT_PASSWORD,
        process.env.SLACK_BOT_USER_REPO,
        process.env.SLACK_BOT_PROJECT);
...
module.exports.main = async (bot, message) => {
    try {
        ...
        ssh.sshCommand(process.env.SLACK_BOT_SSH_KEY,
            ...
            process.env.SLACK_BOT_SSH_SERVER,
            'killall java');
